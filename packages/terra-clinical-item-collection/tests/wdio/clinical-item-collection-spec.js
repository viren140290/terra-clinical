...
viewports.forEach((viewport) => {
  describe('Item Collection', () => {
    ...
    describe('Displays a selectable item collection', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-item-collection/clinical-item-collection/item-collection-selectable'));
    ...
    describe('Displays an item collection with table styles', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-item-collection/clinical-item-collection/item-collection-table-styles'));
    ...
    describe('Displays an item collection with list styles', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-item-collection/clinical-item-collection/item-collection-list-styles'));
    ...
    describe('Displays an item collection with styles applied to list items', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-item-collection/clinical-item-collection/item-collection-item-styles'));
    ...
    describe('Displays an item collection with items with varying content', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-item-collection/clinical-item-collection/item-collection-varying-items'));
