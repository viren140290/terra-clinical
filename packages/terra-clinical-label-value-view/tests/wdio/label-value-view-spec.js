...
viewports.forEach((viewport) => {
  describe('Label Value View', () => {
    ...
    describe('when a text input is provided', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-label-value-view/clinical-label-value-view/text-value-label-value-view'));
    ...
    describe('when a node input is provided', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-label-value-view/clinical-label-value-view/node-value-label-value-view'));
    ...
    describe('when text and node inputs are provided', () => {
      before(() => browser.url('/#/raw/tests/terra-clinical-label-value-view/clinical-label-value-view/multiple-value-label-value-view'));
